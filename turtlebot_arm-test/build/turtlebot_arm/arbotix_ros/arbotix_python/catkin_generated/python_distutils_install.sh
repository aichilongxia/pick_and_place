...
echo_and_run cd "/home/lh/Moveit_control/turtlebot_arm-test/src/turtlebot_arm/arbotix_ros/arbotix_python"
...
echo_and_run /usr/bin/env \
    ...
    "/usr/bin/python" \
    "/home/lh/Moveit_control/turtlebot_arm-test/src/turtlebot_arm/arbotix_ros/arbotix_python/setup.py" \
    build --build-base "/home/lh/Moveit_control/turtlebot_arm-test/build/turtlebot_arm/arbotix_ros/arbotix_python" \
    install \
    $DESTDIR_ARG \
